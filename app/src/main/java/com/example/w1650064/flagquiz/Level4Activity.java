...
public class Level4Activity extends Activity {
    ...
    private ArrayList<Integer> flagIdList = new ArrayList<>();
    ...
    public void start() {
        ...
        flag1 = findViewById(R.id.lvl4Flag1);
        flag2 = findViewById(R.id.lvl4Flag2);
        flag3 = findViewById(R.id.lvl4Flag3);

        editText1 = findViewById(R.id.lvl4Et1);
        editText2 = findViewById(R.id.lvl4Et2);
        editText3 = findViewById(R.id.lvl4Et3);
        scoreTv = findViewById(R.id.lvl4ScoreChanging);

        answ1 = findViewById(R.id.lvl4TvAnswer1);
        answ2 = findViewById(R.id.lvl4TvAnswer2);
        answ3 = findViewById(R.id.lvl4TvAnswer3);
        ...
        correctWrong = findViewById(R.id.lvl4TvCorrectWrong);
        //lastRun = false;
        setRandomFlags();
        setAnswers();
    ...
    public void setRandomFlags() {
        ...
        flagIdList.add(Database.getLastRandomIndex());
    ...
    public void setAnswers() {
        ...
        answerString1 = db.getCountryName(flagIdList.get(0));
        answerString2 = db.getCountryName(flagIdList.get(1));
        answerString3 = db.getCountryName(flagIdList.get(2));
    ...
    public void fixEmptyEditTexts(EditText editText) {
        if (editText.getText().toString().equals("")
                || (editText.getText().toString().equals("Guess a country!"))
